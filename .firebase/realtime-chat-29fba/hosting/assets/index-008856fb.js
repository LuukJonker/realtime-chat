(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();function _r(t,e){const n=Object.create(null),r=t.split(",");for(let s=0;s<r.length;s++)n[r[s]]=!0;return e?s=>!!n[s.toLowerCase()]:s=>!!n[s]}const Ae=Object.freeze({}),As=Object.freeze([]),St=()=>{},Ig=()=>!1,jw=/^on[^a-z]/,ro=t=>jw.test(t),ma=t=>t.startsWith("onUpdate:"),De=Object.assign,Fu=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},Bw=Object.prototype.hasOwnProperty,le=(t,e)=>Bw.call(t,e),Y=Array.isArray,Dr=t=>tc(t)==="[object Map]",Tg=t=>tc(t)==="[object Set]",X=t=>typeof t=="function",Le=t=>typeof t=="string",$u=t=>typeof t=="symbol",we=t=>t!==null&&typeof t=="object",ju=t=>we(t)&&X(t.then)&&X(t.catch),Ag=Object.prototype.toString,tc=t=>Ag.call(t),Bu=t=>tc(t).slice(8,-1),bg=t=>tc(t)==="[object Object]",qu=t=>Le(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Jo=_r(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),qw=_r("bind,cloak,else-if,else,for,html,if,model,on,once,pre,show,slot,text,memo"),nc=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},Hw=/-(\w)/g,mn=nc(t=>t.replace(Hw,(e,n)=>n?n.toUpperCase():"")),Ww=/\B([A-Z])/g,ar=nc(t=>t.replace(Ww,"-$1").toLowerCase()),Wr=nc(t=>t.charAt(0).toUpperCase()+t.slice(1)),br=nc(t=>t?`on${Wr(t)}`:""),Si=(t,e)=>!Object.is(t,e),_s=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},_a=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},xl=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let $d;const ya=()=>$d||($d=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Hu(t){if(Y(t)){const e={};for(let n=0;n<t.length;n++){const r=t[n],s=Le(r)?Qw(r):Hu(r);if(s)for(const i in s)e[i]=s[i]}return e}else{if(Le(t))return t;if(we(t))return t}}const Kw=/;(?![^(]*\))/g,zw=/:([^]+)/,Gw=/\/\*[^]*?\*\//g;function Qw(t){const e={};return t.replace(Gw,"").split(Kw).forEach(n=>{if(n){const r=n.split(zw);r.length>1&&(e[r[0].trim()]=r[1].trim())}}),e}function xs(t){let e="";if(Le(t))e=t;else if(Y(t))for(let n=0;n<t.length;n++){const r=xs(t[n]);r&&(e+=r+" ")}else if(we(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const Yw="html,body,base,head,link,meta,style,title,address,article,aside,footer,header,hgroup,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,ruby,s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,embed,object,param,source,canvas,script,noscript,del,ins,caption,col,colgroup,table,thead,tbody,td,th,tr,button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,output,progress,select,textarea,details,dialog,menu,summary,template,blockquote,iframe,tfoot",Jw="svg,animate,animateMotion,animateTransform,circle,clipPath,color-profile,defs,desc,discard,ellipse,feBlend,feColorMatrix,feComponentTransfer,feComposite,feConvolveMatrix,feDiffuseLighting,feDisplacementMap,feDistantLight,feDropShadow,feFlood,feFuncA,feFuncB,feFuncG,feFuncR,feGaussianBlur,feImage,feMerge,feMergeNode,feMorphology,feOffset,fePointLight,feSpecularLighting,feSpotLight,feTile,feTurbulence,filter,foreignObject,g,hatch,hatchpath,image,line,linearGradient,marker,mask,mesh,meshgradient,meshpatch,meshrow,metadata,mpath,path,pattern,polygon,polyline,radialGradient,rect,set,solidcolor,stop,switch,symbol,text,textPath,title,tspan,unknown,use,view",Xw=_r(Yw),Zw=_r(Jw),eE="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",tE=_r(eE);function Rg(t){return!!t||t===""}const On=t=>Le(t)?t:t==null?"":Y(t)||we(t)&&(t.toString===Ag||!X(t.toString))?JSON.stringify(t,Pg,2):String(t),Pg=(t,e)=>e&&e.__v_isRef?Pg(t,e.value):Dr(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[r,s])=>(n[`${r} =>`]=s,n),{})}:Tg(e)?{[`Set(${e.size})`]:[...e.values()]}:we(e)&&!Y(e)&&!bg(e)?String(e):e;function va(t,...e){console.warn(`[Vue warn] ${t}`,...e)}let kt;class Sg{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=kt,!e&&kt&&(this.index=(kt.scopes||(kt.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const n=kt;try{return kt=this,e()}finally{kt=n}}else va("cannot run an inactive effect scope.")}on(){kt=this}off(){kt=this.parent}stop(e){if(this._active){let n,r;for(n=0,r=this.effects.length;n<r;n++)this.effects[n].stop();for(n=0,r=this.cleanups.length;n<r;n++)this.cleanups[n]();if(this.scopes)for(n=0,r=this.scopes.length;n<r;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0,this._active=!1}}}function Cg(t){return new Sg(t)}function nE(t,e=kt){e&&e.active&&e.effects.push(t)}function kg(){return kt}function rE(t){kt?kt.cleanups.push(t):va("onScopeDispose() is called when there is no active effect scope to be associated with.")}const Wu=t=>{const e=new Set(t);return e.w=0,e.n=0,e},Og=t=>(t.w&cr)>0,xg=t=>(t.n&cr)>0,sE=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=cr},iE=t=>{const{deps:e}=t;if(e.length){let n=0;for(let r=0;r<e.length;r++){const s=e[r];Og(s)&&!xg(s)?s.delete(t):e[n++]=s,s.w&=~cr,s.n&=~cr}e.length=n}},wa=new WeakMap;let oi=0,cr=1;const Nl=30;let At;const Vr=Symbol("iterate"),Dl=Symbol("Map key iterate");class Ku{constructor(e,n=null,r){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,nE(this,r)}run(){if(!this.active)return this.fn();let e=At,n=nr;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=At,At=this,nr=!0,cr=1<<++oi,oi<=Nl?sE(this):jd(this),this.fn()}finally{oi<=Nl&&iE(this),cr=1<<--oi,At=this.parent,nr=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){At===this?this.deferStop=!0:this.active&&(jd(this),this.onStop&&this.onStop(),this.active=!1)}}function jd(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let nr=!0;const Ng=[];function rs(){Ng.push(nr),nr=!1}function ss(){const t=Ng.pop();nr=t===void 0?!0:t}function yt(t,e,n){if(nr&&At){let r=wa.get(t);r||wa.set(t,r=new Map);let s=r.get(n);s||r.set(n,s=Wu()),Dg(s,{effect:At,target:t,type:e,key:n})}}function Dg(t,e){let n=!1;oi<=Nl?xg(t)||(t.n|=cr,n=!Og(t)):n=!t.has(At),n&&(t.add(At),At.deps.push(t),At.onTrack&&At.onTrack(De({effect:At},e)))}function _n(t,e,n,r,s,i){const o=wa.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&Y(t)){const l=Number(r);o.forEach((u,h)=>{(h==="length"||h>=l)&&a.push(u)})}else switch(n!==void 0&&a.push(o.get(n)),e){case"add":Y(t)?qu(n)&&a.push(o.get("length")):(a.push(o.get(Vr)),Dr(t)&&a.push(o.get(Dl)));break;case"delete":Y(t)||(a.push(o.get(Vr)),Dr(t)&&a.push(o.get(Dl)));break;case"set":Dr(t)&&a.push(o.get(Vr));break}const c={target:t,type:e,key:n,newValue:r,oldValue:s,oldTarget:i};if(a.length===1)a[0]&&Vl(a[0],c);else{const l=[];for(const u of a)u&&l.push(...u);Vl(Wu(l),c)}}function Vl(t,e){const n=Y(t)?t:[...t];for(const r of n)r.computed&&Bd(r,e);for(const r of n)r.computed||Bd(r,e)}function Bd(t,e){(t!==At||t.allowRecurse)&&(t.onTrigger&&t.onTrigger(De({effect:t},e)),t.scheduler?t.scheduler():t.run())}function oE(t,e){var n;return(n=wa.get(t))==null?void 0:n.get(e)}const aE=_r("__proto__,__v_isRef,__isVue"),Vg=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter($u)),cE=rc(),lE=rc(!1,!0),uE=rc(!0),hE=rc(!0,!0),qd=dE();function dE(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const r=Z(this);for(let i=0,o=this.length;i<o;i++)yt(r,"get",i+"");const s=r[e](...n);return s===-1||s===!1?r[e](...n.map(Z)):s}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){rs();const r=Z(this)[e].apply(this,n);return ss(),r}}),t}function fE(t){const e=Z(this);return yt(e,"has",t),e.hasOwnProperty(t)}function rc(t=!1,e=!1){return function(r,s,i){if(s==="__v_isReactive")return!t;if(s==="__v_isReadonly")return t;if(s==="__v_isShallow")return e;if(s==="__v_raw"&&i===(t?e?qg:Bg:e?jg:$g).get(r))return r;const o=Y(r);if(!t){if(o&&le(qd,s))return Reflect.get(qd,s,i);if(s==="hasOwnProperty")return fE}const a=Reflect.get(r,s,i);return($u(s)?Vg.has(s):aE(s))||(t||yt(r,"get",s),e)?a:Re(a)?o&&qu(s)?a:a.value:we(a)?t?Wg(a):so(a):a}}const pE=Mg(),gE=Mg(!0);function Mg(t=!1){return function(n,r,s,i){let o=n[r];if(lr(o)&&Re(o)&&!Re(s))return!1;if(!t&&(!Ea(s)&&!lr(s)&&(o=Z(o),s=Z(s)),!Y(n)&&Re(o)&&!Re(s)))return o.value=s,!0;const a=Y(n)&&qu(r)?Number(r)<n.length:le(n,r),c=Reflect.set(n,r,s,i);return n===Z(i)&&(a?Si(s,o)&&_n(n,"set",r,s,o):_n(n,"add",r,s)),c}}function mE(t,e){const n=le(t,e),r=t[e],s=Reflect.deleteProperty(t,e);return s&&n&&_n(t,"delete",e,void 0,r),s}function _E(t,e){const n=Reflect.has(t,e);return(!$u(e)||!Vg.has(e))&&yt(t,"has",e),n}function yE(t){return yt(t,"iterate",Y(t)?"length":Vr),Reflect.ownKeys(t)}const Lg={get:cE,set:pE,deleteProperty:mE,has:_E,ownKeys:yE},Ug={get:uE,set(t,e){return va(`Set operation on key "${String(e)}" failed: target is readonly.`,t),!0},deleteProperty(t,e){return va(`Delete operation on key "${String(e)}" failed: target is readonly.`,t),!0}},vE=De({},Lg,{get:lE,set:gE}),wE=De({},Ug,{get:hE}),zu=t=>t,sc=t=>Reflect.getPrototypeOf(t);function xo(t,e,n=!1,r=!1){t=t.__v_raw;const s=Z(t),i=Z(e);n||(e!==i&&yt(s,"get",e),yt(s,"get",i));const{has:o}=sc(s),a=r?zu:n?Gu:Ci;if(o.call(s,e))return a(t.get(e));if(o.call(s,i))return a(t.get(i));t!==s&&t.get(e)}function No(t,e=!1){const n=this.__v_raw,r=Z(n),s=Z(t);return e||(t!==s&&yt(r,"has",t),yt(r,"has",s)),t===s?n.has(t):n.has(t)||n.has(s)}function Do(t,e=!1){return t=t.__v_raw,!e&&yt(Z(t),"iterate",Vr),Reflect.get(t,"size",t)}function Hd(t){t=Z(t);const e=Z(this);return sc(e).has.call(e,t)||(e.add(t),_n(e,"add",t,t)),this}function Wd(t,e){e=Z(e);const n=Z(this),{has:r,get:s}=sc(n);let i=r.call(n,t);i?Fg(n,r,t):(t=Z(t),i=r.call(n,t));const o=s.call(n,t);return n.set(t,e),i?Si(e,o)&&_n(n,"set",t,e,o):_n(n,"add",t,e),this}function Kd(t){const e=Z(this),{has:n,get:r}=sc(e);let s=n.call(e,t);s?Fg(e,n,t):(t=Z(t),s=n.call(e,t));const i=r?r.call(e,t):void 0,o=e.delete(t);return s&&_n(e,"delete",t,void 0,i),o}function zd(){const t=Z(this),e=t.size!==0,n=Dr(t)?new Map(t):new Set(t),r=t.clear();return e&&_n(t,"clear",void 0,void 0,n),r}function Vo(t,e){return function(r,s){const i=this,o=i.__v_raw,a=Z(o),c=e?zu:t?Gu:Ci;return!t&&yt(a,"iterate",Vr),o.forEach((l,u)=>r.call(s,c(l),c(u),i))}}function Mo(t,e,n){return function(...r){const s=this.__v_raw,i=Z(s),o=Dr(i),a=t==="entries"||t===Symbol.iterator&&o,c=t==="keys"&&o,l=s[t](...r),u=n?zu:e?Gu:Ci;return!e&&yt(i,"iterate",c?Dl:Vr),{next(){const{value:h,done:d}=l.next();return d?{value:h,done:d}:{value:a?[u(h[0]),u(h[1])]:u(h),done:d}},[Symbol.iterator](){return this}}}}function jn(t){return function(...e){{const n=e[0]?`on key "${e[0]}" `:"";console.warn(`${Wr(t)} operation ${n}failed: target is readonly.`,Z(this))}return t==="delete"?!1:this}}function EE(){const t={get(i){return xo(this,i)},get size(){return Do(this)},has:No,add:Hd,set:Wd,delete:Kd,clear:zd,forEach:Vo(!1,!1)},e={get(i){return xo(this,i,!1,!0)},get size(){return Do(this)},has:No,add:Hd,set:Wd,delete:Kd,clear:zd,forEach:Vo(!1,!0)},n={get(i){return xo(this,i,!0)},get size(){return Do(this,!0)},has(i){return No.call(this,i,!0)},add:jn("add"),set:jn("set"),delete:jn("delete"),clear:jn("clear"),forEach:Vo(!0,!1)},r={get(i){return xo(this,i,!0,!0)},get size(){return Do(this,!0)},has(i){return No.call(this,i,!0)},add:jn("add"),set:jn("set"),delete:jn("delete"),clear:jn("clear"),forEach:Vo(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(i=>{t[i]=Mo(i,!1,!1),n[i]=Mo(i,!0,!1),e[i]=Mo(i,!1,!0),r[i]=Mo(i,!0,!0)}),[t,n,e,r]}const[IE,TE,AE,bE]=EE();function ic(t,e){const n=e?t?bE:AE:t?TE:IE;return(r,s,i)=>s==="__v_isReactive"?!t:s==="__v_isReadonly"?t:s==="__v_raw"?r:Reflect.get(le(n,s)&&s in r?n:r,s,i)}const RE={get:ic(!1,!1)},PE={get:ic(!1,!0)},SE={get:ic(!0,!1)},CE={get:ic(!0,!0)};function Fg(t,e,n){const r=Z(n);if(r!==n&&e.call(t,r)){const s=Bu(t);console.warn(`Reactive ${s} contains both the raw and reactive versions of the same object${s==="Map"?" as keys":""}, which can lead to inconsistencies. Avoid differentiating between the raw and reactive versions of an object and only use the reactive version if possible.`)}}const $g=new WeakMap,jg=new WeakMap,Bg=new WeakMap,qg=new WeakMap;function kE(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function OE(t){return t.__v_skip||!Object.isExtensible(t)?0:kE(Bu(t))}function so(t){return lr(t)?t:oc(t,!1,Lg,RE,$g)}function Hg(t){return oc(t,!1,vE,PE,jg)}function Wg(t){return oc(t,!0,Ug,SE,Bg)}function ai(t){return oc(t,!0,wE,CE,qg)}function oc(t,e,n,r,s){if(!we(t))return console.warn(`value cannot be made reactive: ${String(t)}`),t;if(t.__v_raw&&!(e&&t.__v_isReactive))return t;const i=s.get(t);if(i)return i;const o=OE(t);if(o===0)return t;const a=new Proxy(t,o===2?r:n);return s.set(t,a),a}function zt(t){return lr(t)?zt(t.__v_raw):!!(t&&t.__v_isReactive)}function lr(t){return!!(t&&t.__v_isReadonly)}function Ea(t){return!!(t&&t.__v_isShallow)}function Ia(t){return zt(t)||lr(t)}function Z(t){const e=t&&t.__v_raw;return e?Z(e):t}function Rn(t){return _a(t,"__v_skip",!0),t}const Ci=t=>we(t)?so(t):t,Gu=t=>we(t)?Wg(t):t;function Kg(t){nr&&At&&(t=Z(t),Dg(t.dep||(t.dep=Wu()),{target:t,type:"get",key:"value"}))}function zg(t,e){t=Z(t);const n=t.dep;n&&Vl(n,{target:t,type:"set",key:"value",newValue:e})}function Re(t){return!!(t&&t.__v_isRef===!0)}function xe(t){return Gg(t,!1)}function xE(t){return Gg(t,!0)}function Gg(t,e){return Re(t)?t:new NE(t,e)}class NE{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:Z(e),this._value=n?e:Ci(e)}get value(){return Kg(this),this._value}set value(e){const n=this.__v_isShallow||Ea(e)||lr(e);e=n?e:Z(e),Si(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:Ci(e),zg(this,e))}}function Ne(t){return Re(t)?t.value:t}const DE={get:(t,e,n)=>Ne(Reflect.get(t,e,n)),set:(t,e,n,r)=>{const s=t[e];return Re(s)&&!Re(n)?(s.value=n,!0):Reflect.set(t,e,n,r)}};function Qg(t){return zt(t)?t:new Proxy(t,DE)}function Gd(t){Ia(t)||console.warn("toRefs() expects a reactive object but received a plain one.");const e=Y(t)?new Array(t.length):{};for(const n in t)e[n]=Yg(t,n);return e}class VE{constructor(e,n,r){this._object=e,this._key=n,this._defaultValue=r,this.__v_isRef=!0}get value(){const e=this._object[this._key];return e===void 0?this._defaultValue:e}set value(e){this._object[this._key]=e}get dep(){return oE(Z(this._object),this._key)}}class ME{constructor(e){this._getter=e,this.__v_isRef=!0,this.__v_isReadonly=!0}get value(){return this._getter()}}function Xo(t,e,n){return Re(t)?t:X(t)?new ME(t):we(t)&&arguments.length>1?Yg(t,e,n):xe(t)}function Yg(t,e,n){const r=t[e];return Re(r)?r:new VE(t,e,n)}class LE{constructor(e,n,r,s){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new Ku(e,()=>{this._dirty||(this._dirty=!0,zg(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!s,this.__v_isReadonly=r}get value(){const e=Z(this);return Kg(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function UE(t,e,n=!1){let r,s;const i=X(t);i?(r=t,s=()=>{console.warn("Write operation failed: computed value is readonly")}):(r=t.get,s=t.set);const o=new LE(r,s,i||!s,n);return e&&!n&&(o.effect.onTrack=e.onTrack,o.effect.onTrigger=e.onTrigger),o}const Mr=[];function Zo(t){Mr.push(t)}function ea(){Mr.pop()}function S(t,...e){rs();const n=Mr.length?Mr[Mr.length-1].component:null,r=n&&n.appContext.config.warnHandler,s=FE();if(r)kn(r,n,11,[t+e.join(""),n&&n.proxy,s.map(({vnode:i})=>`at <${pc(n,i.type)}>`).join(`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Da=new Map,uu=new Map;function oR(t,e){try{t.container.addComponent(e)}catch(n){Qr.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Yr(t){const e=t.name;if(uu.has(e))return Qr.debug(`There were multiple attempts to register component ${e}.`),!1;uu.set(e,t);for(const n of Da.values())oR(n,t);return!0}function yc(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const is=sR;function m_(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:lu,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw ir.create("bad-app-name",{appName:String(s)});if(n||(n=h_()),!n)throw ir.create("no-options");const i=Da.get(s);if(i){if(Na(n,i.options)&&Na(r,i.config))return i;throw ir.create("duplicate-app",{appName:s})}const o=new m0(s);for(const c of uu.values())o.addComponent(c);const a=new cR(n,r,o);return Da.set(s,a),a}function vh(t=lu){const e=Da.get(t);if(!e&&t===lu&&h_())return m_();if(!e)throw ir.create("no-app",{appName:t});return e}function hn(t,e,n){var r;let s=(r=iR[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${s}" with version "${e}":`];i&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Qr.warn(a.join(" "));return}Yr(new dr(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Va=new _h("@firebase/auth");function IR(t,...e){Va.logLevel<=me.WARN&&Va.warn(`Auth (${is}): ${t}`,...e)}function ca(t,...e){Va.logLevel<=me.ERROR&&Va.error(`Auth (${is}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ei(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function NR(t,e=!1){const n=Ye(t),r=await n.getIdToken(e),s=Th(r);ee(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,o=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:Ei(pl(s.auth_time)),issuedAtTime:Ei(pl(s.iat)),expirationTime:Ei(pl(s.exp)),signInProvider:o||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function pl(t){return Number(t)*1e3}function Th(t){const[e,n,r]=t.split(".");if(e===void 0||n===void 0||r===void 0)return ca("JWT malformed, contained fewer than 3 sections"),null;try{const s=c_(n);return s?JSON.parse(s):(ca("Failed to decode base64 JWT payload"),null)}catch(s){return ca("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function DR(t){const e=Th(t);return ee(e,"internal-error"),ee(typeof e.exp<"u","internal-error"),ee(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rp(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(C_(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(P_(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(O_(e))return"Blackberry";if(x_(e))return"Webos";if(Ah(e))return"Safari";if((e.includes("chrome/")||S_(e))&&!e.includes("edge/"))return"Chrome";if(k_(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function P_(t=vt()){return/firefox\//i.test(t)}function Ah(t=vt()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function S_(t=vt()){return/crios\//i.test(t)}function C_(t=vt()){return/iemobile/i.test(t)}function k_(t=vt()){return/android/i.test(t)}function O_(t=vt()){return/blackberry/i.test(t)}function x_(t=vt()){return/webos/i.test(t)}function vc(t=vt()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function jR(t=vt()){var e;return vc(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function BR(){return r0()&&document.documentMode===10}function N_(t=vt()){return vc(t)||k_(t)||x_(t)||O_(t)||/windows phone/i.test(t)||C_(t)}function qR(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ua extends vn{constructor(e,n,r,s){var i;super(n.code,n.message),this.operationType=r,this.user=s,Object.setPrototypeOf(this,Ua.prototype),this.customData={appName:e.name,tenantId:(i=e.tenantId)!==null&&i!==void 0?i:void 0,_serverResponse:n.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(e,n,r,s){return new Ua(e,n,r,s)}}function L_(t,e,n,r){return(e==="reauthenticate"?n._getReauthenticationResolver(t):n._getIdTokenResponse(t)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?Ua._fromErrorAndOperation(t,i,e,r):i})}async function dP(t,e,n=!1){const r=await Vs(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return Xr._forOperation(t,"link",r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function F_(t){const e=vr(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function gP(t,e,n){var r;const s=vr(t),i={returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"};let o;if(!((r=s._getRecaptchaConfig())===null||r===void 0)&&r.emailPasswordEnabled){const l=await La(s,i,"signUpPassword");o=ml(s,l)}else o=ml(s,i).catch(async l=>{if(l.code==="auth/missing-recaptcha-token"){console.log("Sign-up is protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the sign-up flow.");const u=await La(s,i,"signUpPassword");return ml(s,u)}throw l});const a=await o.catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&F_(t),l}),c=await Xr._fromIdTokenResponse(s,"signIn",a);return await s._updateCurrentUser(c.user),c}function mP(t,e,n){return pP(Ye(t),Hs.credential(e,n)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&F_(t),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class j_{constructor(e,n){this.storageRetriever=e,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(Fa,"1"),this.storage.removeItem(Fa),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,n){return this.storage.setItem(e,JSON.stringify(n)),Promise.resolve()}_get(e){const n=this.storage.getItem(e);return Promise.resolve(n?JSON.parse(n):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jP="pendingRedirect",ua=new Map;class BP extends Y_{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=ua.get(this.auth._key());if(!e){try{const r=await qP(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}ua.set(this.auth._key(),e)}return this.bypassAuthState||ua.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function qP(t,e){const n=KP(e),r=WP(t);if(!await r._isAvailable())return!1;const s=await r._get(n)==="true";return await r._remove(n),s}function HP(t,e){ua.set(t._key(),e)}function WP(t){return Sn(t._redirectPersistence)}function KP(t){return la(jP,t.config.apiKey,t.name)}async function zP(t,e,n=!1){const r=vr(t),s=Q_(r,e),o=await new BP(r,s,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cC{constructor(e,n,r,s,i,o,a,c,l,u,h,d=!0){this.url_=e,this.method_=n,this.headers_=r,this.body_=s,this.successCodes_=i,this.additionalRetryCodes_=o,this.callback_=a,this.errorCallback_=c,this.timeout_=l,this.progressCallback_=u,this.connectionFactory_=h,this.retry=d,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((p,_)=>{this.resolve_=p,this.reject_=_,this.start_()})}start_(){const e=(r,s)=>{if(s){r(!1,new jo(!1,null,!0));return}const i=this.connectionFactory_();this.pendingConnection_=i;const o=a=>{const c=a.loaded,l=a.lengthComputable?a.total:-1;this.progressCallback_!==null&&this.progressCallback_(c,l)};this.progressCallback_!==null&&i.addUploadProgressListener(o),i.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&i.removeUploadProgressListener(o),this.pendingConnection_=null;const a=i.getErrorCode()===jr.NO_ERROR,c=i.getStatus();if(!a||aC(c,this.additionalRetryCodes_)&&this.retry){const u=i.getErrorCode()===jr.ABORT;r(!1,new jo(!1,null,u));return}const l=this.successCodes_.indexOf(c)!==-1;r(!0,new jo(l,i))})},n=(r,s)=>{const i=this.resolve_,o=this.reject_,a=s.connection;if(s.wasSuccessCode)try{const c=this.callback_(a,a.getResponse());iC(c)?i(c):i()}catch(c){o(c)}else if(a!==null){const c=kh();c.serverResponse=a.getErrorText(),this.errorCallback_?o(this.errorCallback_(a,c)):o(c)}else if(s.canceled){const c=this.appDelete_?ty():GS();o(c)}else{const c=zS();o(c)}};this.canceled_?n(!1,new jo(!1,null,!0)):this.backoffId_=rC(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&sC(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class jo{constructor(e,n,r){this.wasSuccessCode=e,this.connection=n,this.canceled=!!r}}function lC(t,e){e!==null&&e.length>0&&(t.Authorization="Firebase "+e)}function uC(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function hC(t,e){e&&(t["X-Firebase-GMPID"]=e)}function dC(t,e){e!==null&&(t["X-Firebase-AppCheck"]=e)}function fC(t,e,n,r,s,i,o=!0){const a=ny(t.urlParams),c=t.url+a,l=Object.assign({},t.headers);return hC(l,e),lC(l,n),uC(l,i),dC(l,r),new cC(c,t.method,l,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,s,o)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bC(t,e){return e}class It{constructor(e,n,r,s){this.server=e,this.local=n||e,this.writable=!!r,this.xform=s||bC}}let Bo=null;function RC(t){return!Oh(t)||t.length<2?t:ay(t)}function cy(){if(Bo)return Bo;const t=[];t.push(new It("bucket")),t.push(new It("generation")),t.push(new It("metageneration")),t.push(new It("name","fullPath",!0));function e(i,o){return RC(o)}const n=new It("name");n.xform=e,t.push(n);function r(i,o){return o!==void 0?Number(o):o}const s=new It("size");return s.xform=r,t.push(s),t.push(new It("timeCreated")),t.push(new It("updated")),t.push(new It("md5Hash",null,!0)),t.push(new It("cacheControl",null,!0)),t.push(new It("contentDisposition",null,!0)),t.push(new It("contentEncoding",null,!0)),t.push(new It("contentLanguage",null,!0)),t.push(new It("contentType",null,!0)),t.push(new It("metadata","customMetadata",!0)),Bo=t,Bo}function PC(t,e){function n(){const r=t.bucket,s=t.fullPath,i=new Ot(r,s);return e._makeStorageReference(i)}Object.defineProperty(t,"ref",{get:n})}function SC(t,e,n){const r={};r.type="file";const s=n.length;for(let i=0;i<s;i++){const o=n[i];r[o.local]=o.xform(r,e[o.server])}return PC(r,t),r}function ly(t,e,n){const r=oy(e);return r===null?null:SC(t,r,n)}function CC(t,e,n,r){const s=oy(e);if(s===null||!Oh(s.downloadTokens))return null;const i=s.downloadTokens;if(i.length===0)return null;const o=encodeURIComponent;return i.split(",").map(l=>{const u=t.bucket,h=t.fullPath,d="/b/"+o(u)+"/o/"+o(h),p=Nh(d,n,r),_=ny({alt:"media",token:l});return p+_})[0]}function kC(t,e){const n={},r=e.length;for(let s=0;s<r;s++){const i=e[s];i.writable&&(n[i.server]=t[i.local])}return JSON.stringify(n)}class uy{constructor(e,n,r,s){this.url=e,this.method=n,this.handler=r,this.timeout=s,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function te(t="Unexpected state"){const e=`FIRESTORE (${zs}) INTERNAL ASSERTION FAILED: `+t;throw Dn(e),new Error(e)}function Ce(t,e){t||te()}function ae(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sd{constructor(e,n){this.previousValue=e,n&&(n.sequenceNumberHandler=r=>this.oe(r),this._e=r=>n.writeSequenceNumber(r))}oe(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this._e&&this._e(e),e}}sd.ae=-1;function Fc(t){return t==null}function Ga(t){return t===0&&1/t==-1/0}function IO(t){return typeof t=="number"&&Number.isInteger(t)&&!Ga(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $t{constructor(e){this.value=e}static empty(){return new $t({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let n=this.value;for(let r=0;r<e.length-1;++r)if(n=(n.mapValue.fields||{})[e.get(r)],!da(n))return null;return n=(n.mapValue.fields||{})[e.lastSegment()],n||null}}set(e,n){this.getFieldsMap(e.popLast())[e.lastSegment()]=Ai(n)}setAll(e){let n=ft.emptyPath(),r={},s=[];e.forEach((o,a)=>{if(!n.isImmediateParentOf(a)){const c=this.getFieldsMap(n);this.applyChanges(c,r,s),r={},s=[],n=a.popLast()}o?r[a.lastSegment()]=Ai(o):s.push(a.lastSegment())});const i=this.getFieldsMap(n);this.applyChanges(i,r,s)}delete(e){const n=this.field(e.popLast());da(n)&&n.mapValue.fields&&delete n.mapValue.fields[e.lastSegment()]}isEqual(e){return yn(this.value,e.value)}getFieldsMap(e){let n=this.value;n.mapValue.fields||(n.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=n.mapValue.fields[e.get(r)];da(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},n.mapValue.fields[e.get(r)]=s),n=s}return n.mapValue.fields}applyChanges(e,n,r){Gs(n,(s,i)=>e[s]=i);for(const s of r)delete e[s]}clone(){return new $t(Ai(this.value))}}function Iv(t){const e=[];return Gs(t.fields,(n,r)=>{const s=new ft([n]);if(da(r)){const i=Iv(r.mapValue).fields;if(i.length===0)e.push(s);else for(const o of i)e.push(s.child(o))}else e.push(s)}),new Kt(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vv(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ga(e)?"-0":e}}function Mv(t){return{integerValue:""+t}}function WO(t,e){return IO(e)?Mv(e):Vv(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qc{constructor(){this._=void 0}}function KO(t,e,n){return t instanceof Ya?function(s,i){const o={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&id(i)&&(i=od(i)),i&&(o.fields.__previous_value__=i),{mapValue:o}}(n,e):t instanceof eo?Uv(t,e):t instanceof to?Fv(t,e):function(s,i){const o=Lv(s,i),a=Gp(o)+Gp(s.Ee);return Pu(o)&&Pu(s.Ee)?Mv(a):Vv(s.serializer,a)}(t,e)}function zO(t,e,n){return t instanceof eo?Uv(t,e):t instanceof to?Fv(t,e):n}function Lv(t,e){return t instanceof Ja?function(r){return Pu(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class Ya extends qc{}class eo extends qc{constructor(e){super(),this.elements=e}}function Uv(t,e){const n=$v(e);for(const r of t.elements)n.some(s=>yn(s,r))||n.push(r);return{arrayValue:{values:n}}}class to extends qc{constructor(e){super(),this.elements=e}}function Fv(t,e){let n=$v(e);for(const r of t.elements)n=n.filter(s=>!yn(s,r));return{arrayValue:{values:n}}}class Ja extends qc{constructor(e,n){super(),this.serializer=e,this.Ee=n}}function Gp(t){return He(t.integerValue||t.doubleValue)}function $v(t){return ad(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}function GO(t,e){return t.field.isEqual(e.field)&&function(r,s){return r instanceof eo&&s instanceof eo||r instanceof to&&s instanceof to?Us(r.elements,s.elements,yn):r instanceof Ja&&s instanceof Ja?yn(r.Ee,s.Ee):r instanceof Ya&&s instanceof Ya}(t.transform,e.transform)}class QO{constructor(e,n){this.version=e,this.transformResults=n}}class pn{constructor(e,n){this.updateTime=e,this.exists=n}static none(){return new pn}static exists(e){return new pn(void 0,e)}static updateTime(e){return new pn(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function fa(t,e){return t.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(t.updateTime):t.exists===void 0||t.exists===e.isFoundDocument()}class Hc{}function jv(t,e){if(!t.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return t.isNoDocument()?new qv(t.key,pn.none()):new Ao(t.key,t.data,pn.none());{const n=t.data,r=$t.empty();let s=new _t(ft.comparator);for(let i of e.fields)if(!s.has(i)){let o=n.field(i);o===null&&i.length>1&&(i=i.popLast(),o=n.field(i)),o===null?r.delete(i):r.set(i,o),s=s.add(i)}return new cs(t.key,r,new Kt(s.toArray()),pn.none())}}function YO(t,e,n){t instanceof Ao?function(s,i,o){const a=s.value.clone(),c=Yp(s.fieldTransforms,i,o.transformResults);a.setAll(c),i.convertToFoundDocument(o.version,a).setHasCommittedMutations()}(t,e,n):t instanceof cs?function(s,i,o){if(!fa(s.precondition,i))return void i.convertToUnknownDocument(o.version);const a=Yp(s.fieldTransforms,i,o.transformResults),c=i.data;c.setAll(Bv(s)),c.setAll(a),i.convertToFoundDocument(o.version,c).setHasCommittedMutations()}(t,e,n):function(s,i,o){i.convertToNoDocument(o.version).setHasCommittedMutations()}(0,e,n)}function Pi(t,e,n,r){return t instanceof Ao?function(i,o,a,c){if(!fa(i.precondition,o))return a;const l=i.value.clone(),u=Jp(i.fieldTransforms,c,o);return l.setAll(u),o.convertToFoundDocument(o.version,l).setHasLocalMutations(),null}(t,e,n,r):t instanceof cs?function(i,o,a,c){if(!fa(i.precondition,o))return a;const l=Jp(i.fieldTransforms,c,o),u=o.data;return u.setAll(Bv(i)),u.setAll(l),o.convertToFoundDocument(o.version,u).setHasLocalMutations(),a===null?null:a.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(h=>h.field))}(t,e,n,r):function(i,o,a){return fa(i.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):a}(t,e,n)}function JO(t,e){let n=null;for(const r of t.fieldTransforms){const s=e.data.field(r.field),i=Lv(r.transform,s||null);i!=null&&(n===null&&(n=$t.empty()),n.set(r.field,i))}return n||null}function Qp(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&Us(r,s,(i,o)=>GO(i,o))}(t.fieldTransforms,e.fieldTransforms)&&(t.type===0?t.value.isEqual(e.value):t.type!==1||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}class Ao extends Hc{constructor(e,n,r,s=[]){super(),this.key=e,this.value=n,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class cs extends Hc{constructor(e,n,r,s,i=[]){super(),this.key=e,this.data=n,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function Bv(t){const e=new Map;return t.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const r=t.data.field(n);e.set(n,r)}}),e}function Yp(t,e,n){const r=new Map;Ce(t.length===n.length);for(let s=0;s<n.length;s++){const i=t[s],o=i.transform,a=e.data.field(i.field);r.set(i.field,zO(o,a,n[s]))}return r}function Jp(t,e,n){const r=new Map;for(const s of t){const i=s.transform,o=n.data.field(s.field);r.set(s.field,KO(i,o,e))}return r}class qv extends Hc{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class XO extends Hc{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wc{constructor(e,n,r,s,i){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const s=new Map;return s.set(e,bo.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new Wc(oe.min(),s,new Me(ye),Mn(),he())}}class bo{constructor(e,n,r,s,i){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new bo(r,n,he(),he(),he())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gd{constructor(){this.Pr=new _t(Xe.Ir),this.Tr=new _t(Xe.Er)}isEmpty(){return this.Pr.isEmpty()}addReference(e,n){const r=new Xe(e,n);this.Pr=this.Pr.add(r),this.Tr=this.Tr.add(r)}dr(e,n){e.forEach(r=>this.addReference(r,n))}removeReference(e,n){this.Ar(new Xe(e,n))}Rr(e,n){e.forEach(r=>this.removeReference(r,n))}Vr(e){const n=new Q(new Se([])),r=new Xe(n,e),s=new Xe(n,e+1),i=[];return this.Tr.forEachInRange([r,s],o=>{this.Ar(o),i.push(o.key)}),i}mr(){this.Pr.forEach(e=>this.Ar(e))}Ar(e){this.Pr=this.Pr.delete(e),this.Tr=this.Tr.delete(e)}gr(e){const n=new Q(new Se([])),r=new Xe(n,e),s=new Xe(n,e+1);let i=he();return this.Tr.forEachInRange([r,s],o=>{i=i.add(o.key)}),i}containsKey(e){const n=new Xe(e,0),r=this.Pr.firstAfterOrEqual(n);return r!==null&&e.isEqual(r.key)}}class Xe{constructor(e,n){this.key=e,this.pr=n}static Ir(e,n){return Q.comparator(e.key,n.key)||ye(e.pr,n.pr)}static Er(e,n){return ye(e.pr,n.pr)||Q.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kc(t){return new l1(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mi{constructor(e,n){this.hasPendingWrites=e,this.fromCache=n}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class Dw extends Sw{constructor(e,n,r,s,i,o){super(e,n,r,s,o),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const n=new ga(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,n={}){if(this._document){const r=this._document.data.field(Jc("DocumentSnapshot.get",e));if(r!==null)return this._userDataWriter.convertValue(r,n.serverTimestamps)}}}class ga extends Dw{data(e={}){return super.data(e)}}class sN{constructor(e,n,r,s){this._firestore=e,this._userDataWriter=n,this._snapshot=s,this.metadata=new mi(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const e=[];return this.forEach(n=>e.push(n)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,n){this._snapshot.docs.forEach(r=>{e.call(n,new ga(this._firestore,this._userDataWriter,r.key,r,new mi(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const n=!!e.includeMetadataChanges;if(n&&this._snapshot.excludesMetadataChanges)throw new $(T.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===n||(this._cachedChanges=function(s,i){if(s._snapshot.oldDocs.isEmpty()){let o=0;return s._snapshot.docChanges.map(a=>{const c=new ga(s._firestore,s._userDataWriter,a.doc.key,a.doc,new mi(s._snapshot.mutatedKeys.has(a.doc.key),s._snapshot.fromCache),s.query.converter);return a.doc,{type:"added",doc:c,oldIndex:-1,newIndex:o++}})}{let o=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(a=>i||a.type!==3).map(a=>{const c=new ga(s._firestore,s._userDataWriter,a.doc.key,a.doc,new mi(s._snapshot.mutatedKeys.has(a.doc.key),s._snapshot.fromCache),s.query.converter);let l=-1,u=-1;return a.type!==0&&(l=o.indexOf(a.doc.key),o=o.delete(a.doc.key)),a.type!==1&&(o=o.add(a.doc),u=o.indexOf(a.doc.key)),{type:iN(a.type),doc:c,oldIndex:l,newIndex:u}})}}(this,n),this._cachedChangesIncludeMetadataChanges=n),this._cachedChanges}}function iN(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return te()}}class Vw extends rN{constructor(e){super(),this.firestore=e}convertBytes(e){return new qs(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Ct(this.firestore,null,n)}}function Mw(t,e,n){t=Hr(t,Ct);const r=Hr(t.firestore,no),s=Nw(t.converter,e,n);return Uw(r,[Tw(Cd(r),"setDoc",t._key,s,t.converter!==null,n).toMutation(t._key,pn.none())])}function Lw(t,e){const n=Hr(t.firestore,no),r=bd(t),s=Nw(t.converter,e);return Uw(n,[Tw(Cd(t.firestore),"addDoc",r._key,s,t.converter!==null,{}).toMutation(r._key,pn.exists(!1))]).then(()=>r)}function Dd(t,...e){var n,r,s;t=Ye(t);let i={includeMetadataChanges:!1},o=0;typeof e[o]!="object"||yg(e[o])||(i=e[o],o++);const a={includeMetadataChanges:i.includeMetadataChanges};if(yg(e[o])){const h=e[o];e[o]=(n=h.next)===null||n===void 0?void 0:n.bind(h),e[o+1]=(r=h.error)===null||r===void 0?void 0:r.bind(h),e[o+2]=(s=h.complete)===null||s===void 0?void 0:s.bind(h)}let c,l,u;if(t instanceof Ct)l=Hr(t.firestore,no),u=ud(t._key.path),c={next:h=>{e[o]&&e[o](oN(l,t,h))},error:e[o+1],complete:e[o+2]};else{const h=Hr(t,us);l=Hr(h.firestore,no),u=h._query;const d=new Vw(l);c={next:p=>{e[o]&&e[o](new sN(l,d,h,p))},error:e[o+1],complete:e[o+2]},eN(t._query)}return function(d,p,_,I){const w=new Lx(I),b=new vx(p,w,_);return d.asyncQueue.enqueueAndForget(async()=>gx(await fg(d),b)),()=>{w.Ma(),d.asyncQueue.enqueueAndForget(async()=>mx(await fg(d),b))}}(vw(l),u,a,c)}function Uw(t,e){return function(r,s){const i=new qr;return r.asyncQueue.enqueueAndForget(async()=>Px(await jx(r),s,i)),i.promise}(vw(t),e)}function oN(t,e,n){const r=n.docs.get(e._key),s=new Vw(t);return new Dw(t,s,e._key,r,new mi(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(s){zs=s})(is),Yr(new dr("firestore",(r,{instanceIdentifier:s,options:i})=>{const o=r.getProvider("app").getImmediate(),a=new no(new uO(r.getProvider("auth-internal")),new pO(r.getProvider("app-check-internal")),function(l,u){if(!Object.prototype.hasOwnProperty.apply(l.options,["projectId"]))throw new $(T.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Xi(l.options.projectId,u)}(o,s),o);return i=Object.assign({useFetchStreams:n},i),a._setSettings(i),a},"PUBLIC").setMultipleInstances(!0)),hn(Mp,"4.1.2",e),hn(Mp,"4.1.2","esm2017")})();const hs=Wx(Ic),Fw=(t,e,n)=>{const r=bd(hs,"users",t);return Mw(r,{displayName:e??"",photoURL:n??null})},aN=(t,e)=>{const n=bd(hs,"users",t);return Mw(n,e,{merge:!0})},cN=async t=>{const e=So(hs,"chats");return(await Lw(e,{participants:t,updatedAt:new Date,createdAt:new Date})).id},lN=async(t,e)=>{const n=So(hs,"chats",t,"messages"),r=je.currentUser;if(!r)throw new Error("User not found in sendMessage");return await Lw(n,{chatId:t,senderId:r.uid,content:e,createdAt:new Date})},uN=t=>{const e=So(hs,"users");return Dd(e,r=>{const s=r.docs.map(i=>({id:i.id,...i.data()}));t(s)})},hN=t=>{const e=je.currentUser;if(!e)throw new Error("User not found in sendMessage");const n=So(hs,"chats"),r=kw(n,tN("participants","array-contains",e.uid));return Dd(r,i=>{const o=i.docs.map(a=>({id:a.id,...a.data()}));t(o)})},dN=(t,e)=>{const n=So(hs,"chats",t,"messages"),r=kw(n,nN("createdAt","asc"));return Dd(r,i=>{const o=i.metadata.fromCache?"local":"server",a=i.docs.map(c=>({id:c.id,...c.data()}));e({messages:a,source:o})})},je=X_(Ic),fN=t=>je.onAuthStateChanged(t),pN=new bn,gN=()=>$P(je,pN),mN=(t,e)=>mP(je,t,e),_N=(t,e,n,r)=>gP(je,t,e).then(async s=>{const i=s.user;let o;return r&&await tk(r,i.uid).then(a=>{o=a}).catch(a=>{console.log("error handled here",a)}),await Promise.all([$_(i,{displayName:n,photoURL:o}),Fw(i.uid,n,o)]),{user:i,error:null}}).catch(s=>{const i=s.code,o=s.message;return console.log("Error occurred in register",i,o),{user:null,error:{errorCode:i,errorMessage:o}}}),yN=()=>je.signOut(),Co="/assets/profile-icon-37af14f3.png",vN={class:"flex justify-between items-center bg-primary text-onLight p-2 m-2 rounded-lg"},wN={class:"flex justify-start items-center gap-2"},EN=["src"],IN={class:"text-xl"},TN=Je({__name:"ProfileSection",props:{user:{type:Object,required:!0}},setup(t){return(e,n)=>{const r=SI("RouterLink");return ne(),_e("div",vN,[H("div",wN,[H("img",{src:e.user.photoURL?e.user.photoURL:Ne(Co),alt:"Profile",class:"w-16 aspect-square object-cover rounded-full",referrerpolicy:"no-referrer"},null,8,EN),H("h1",IN,On(e.user.displayName),1)]),et(r,{to:"/settings",class:"bg-primary text-onLight p-2 rounded-lg"},{default:uc(()=>[sh("Settings")]),_:1})])}}}),AN=at(TN,[["__file","/home/luuk/code/realtime-chat/src/components/ProfileSection.vue"]]),Vd=fh("users",()=>{const t=xe([]);return uN(e=>{t.value=e}),{users:t}}),ko=fh("chats",()=>{const t=xe([]),e=new Set,n=i=>e.has(i),r=i=>{e.has(i)||(dN(i,({messages:o,source:a})=>{a!=="local"&&(t.value=t.value.map(c=>(c.id===i&&(c.messages=o),c)))}),e.add(i))};hN(i=>{t.value=i,i.forEach(o=>r(o.id))});const s=Ve(()=>{const i=new Set;return t.value.forEach(o=>{o.participants.forEach(a=>{var c;a!==((c=je.currentUser)==null?void 0:c.uid)&&i.add(a)})}),i});return{chats:t,contacts:s,isSubscribed:n,subscribe:r}}),bN=["src"],RN={class:"flex flex-col gap-2"},PN=Je({__name:"UserCard",props:{user:{type:Object,required:!0}},setup(t){const n=t.user,r=async()=>{var i;if(!je.currentUser)return;const s=await cN([n.id,(i=je.currentUser)==null?void 0:i.uid]);mr.push(`/${s}`)};return(s,i)=>(ne(),_e("button",{onClick:r,class:"flex gap-4 p-4 rounded-lg items-center bg-surface-200"},[H("img",{src:Ne(n).photoURL?Ne(n).photoURL:Ne(Co),alt:"Profile",height:"64",width:"64",class:"w-16 aspect-square rounded-full object-cover",referrerpolicy:"no-referrer"},null,8,bN),H("div",RN,[H("h2",null,On(Ne(n).displayName),1)])]))}}),SN=at(PN,[["__file","/home/luuk/code/realtime-chat/src/components/userCard/UserCard.vue"]]),CN=["src"],kN={class:"flex flex-col gap-[2px]"},ON={class:"text-lg text-onDark"},xN={key:0,class:"text-onDark emphasis-high"},NN={key:1,class:"text-onDark emphasis-high animate-pulse"},DN=Je({__name:"ContactCard",props:{chat:{type:Object,required:!0}},setup(t){const e=t,n=Vd(),r=Ve(()=>{var c;if(e.chat.groupchat)return{displayName:e.chat.groupchat.name,photoURL:e.chat.groupchat.photoURL};const i=(c=je.currentUser)==null?void 0:c.uid,o=e.chat.participants.find(l=>l!==i);return n.users.find(l=>l.id===o)??{}}),s=Ve(()=>{var i,o,a;return console.log("Computing",e.chat,(o=(i=e.chat.messages)==null?void 0:i.at(0))==null?void 0:o.content),(a=e.chat.messages)==null?void 0:a.at(0)});return(i,o)=>i.$props.chat.messages?(ne(),Nt(Ne(mh),{key:0,to:`/${i.chat.id}`,class:"flex items-center rounded-lg p-4 gap-4 bg-surface-400 hover:bg-surface-500"},{default:uc(()=>[H("img",{src:r.value.photoURL?r.value.photoURL:Ne(Co),alt:"Profile",height:"64",width:"64",class:"w-16 aspect-square rounded-full object-cover",referrerpolicy:"no-referrer"},null,8,CN),H("div",kN,[H("h2",ON,On(r.value.displayName),1),s.value?(ne(),_e("p",xN,On(s.value.content),1)):(ne(),_e("div",NN))])]),_:1},8,["to"])):zr("v-if",!0)}}),$w=at(DN,[["__file","/home/luuk/code/realtime-chat/src/components/contactCard/ContactCard.vue"]]),VN={key:0,class:"flex-1 flex flex-col gap-2 mx-2 mt-4"},MN=H("h2",{class:"text-lg text-onDark emphasis-high"},"Contacts",-1),LN={key:1,class:"flex-1 flex flex-col gap-2 mx-2 mt-4"},UN=H("h2",{class:"text-lg text-onDark emphasis-high"},"Users",-1),FN={key:2,class:"flex-1 flex justify-center items-center"},$N=H("p",{class:"text-2xl"},"No users found",-1),jN=[$N],BN=Je({__name:"UserList",props:{search:{type:String,required:!0}},setup(t){const e=t,n=Vd(),r=ko(),s=r.contacts,i=Ve(()=>{const l=e.search.toLowerCase();return n.users.filter(u=>u.displayName.toLowerCase().includes(l))}),o=Ve(()=>i.value.filter(l=>s.has(l.id))),a=Ve(()=>r.chats.filter(l=>l.participants.some(u=>{var h;return u===((h=je.currentUser)==null?void 0:h.uid)}))),c=Ve(()=>i.value.filter(l=>{var u;return l.id===((u=je.currentUser)==null?void 0:u.uid)?!1:!s.has(l.id)}));return(l,u)=>(ne(),_e(st,null,[o.value?(ne(),_e("div",VN,[MN,(ne(!0),_e(st,null,Ra(a.value,h=>(ne(),Nt($w,{key:h.id,chat:h},null,8,["chat"]))),128))])):zr("v-if",!0),i.value?(ne(),_e("div",LN,[UN,(ne(!0),_e(st,null,Ra(c.value,h=>(ne(),Nt(SN,{key:h.id,user:h},null,8,["user"]))),128))])):(ne(),_e("div",FN,jN))],64))}}),qN=at(BN,[["__file","/home/luuk/code/realtime-chat/src/components/userCard/UserList.vue"]]),HN={key:0,class:"flex-1 flex flex-col gap-2 mx-2 mt-4"},WN=Je({__name:"ChatList",setup(t){const e=ko(),{chats:n}=Oa(e);return(r,s)=>Ne(n).length?(ne(),_e("div",HN,[(ne(!0),_e(st,null,Ra(Ne(n),i=>(ne(),Nt($w,{key:i.id,chat:i},null,8,["chat"]))),128))])):zr("v-if",!0)}}),KN=at(WN,[["__file","/home/luuk/code/realtime-chat/src/components/contactCard/ChatList.vue"]]),zN=Je({__name:"UserSection",setup(t){const e=xe("");return(n,r)=>(ne(),_e(st,null,[Xn(H("input",{"onUpdate:modelValue":r[0]||(r[0]=s=>e.value=s),type:"text",placeholder:"Search",class:"p-2 mx-2 rounded-xl text-onDark focus:outline-none text-lg bg-surface-200"},null,512),[[Zn,e.value]]),e.value?(ne(),Nt(qN,{key:0,search:e.value},null,8,["search"])):(ne(),Nt(KN,{key:1}))],64))}}),GN=at(zN,[["__file","/home/luuk/code/realtime-chat/src/components/UserSection.vue"]]),QN={class:"text-xs emphasis-low"},YN=Je({__name:"ChatMessage",props:{message:{type:Object,required:!0}},setup(t){const e=je.currentUser,n=r=>{const s=r.getHours(),i=r.getMinutes(),o=s<10?`0${s}`:`${s}`,a=i<10?`0${i}`:`${i}`;return`${o}:${a}`};return(r,s)=>{var i,o;return ne(),_e("div",{class:xs(["flex flex-col gap-1 p-2 rounded-lg w-80",{"self-end items-end bg-primary text-onLight":r.message.senderId===((i=Ne(e))==null?void 0:i.uid),"self-start items-start bg-surface-400 text-onDark":r.message.senderId!==((o=Ne(e))==null?void 0:o.uid)}])},[H("p",null,On(r.message.content),1),H("p",QN,On(n(r.message.createdAt.toDate())),1)],2)}}}),JN=at(YN,[["__file","/home/luuk/code/realtime-chat/src/components/chat/ChatMessage.vue"]]),XN=fh("inputMessages",()=>{const t=xe(new Map);function e(s,i){t.value.set(s,i)}function n(s){t.value.delete(s)}function r(s){return t.value.get(s)??""}return{inputMessages:t,addInputMessage:e,removeInputMessage:n,getInputMessage:r}}),ZN={class:"flex w-full bg-surface-200 p-2"},eD=["onSubmit"],tD=["value"],nD=H("button",{type:"submit",class:"bg-primary rounded-full w-16 p-2 mx-2 h-10 flex justify-center items-center text-onLight"}," Send ",-1),rD=Je({__name:"ChatInput",props:{chatId:{type:String,required:!0}},setup(t){const e=t,{addInputMessage:n,removeInputMessage:r,getInputMessage:s}=XN(),{subscribe:i}=ko(),o=xe("");rr(()=>e.chatId,()=>{o.value=s(e.chatId)});const a=l=>{const u=l.target;n(e.chatId,u.value),i(e.chatId),o.value=u.value},c=async()=>{const l=lN(e.chatId,o.value);o.value="",r(e.chatId),await l};return(l,u)=>(ne(),_e("div",ZN,[H("form",{class:"flex-1 flex",onSubmit:lh(c,["prevent"])},[H("input",{type:"text",class:"flex-1 p-2 rounded-xl text-onDark focus:outline-none text-lg bg-surface-300",placeholder:"Type a message...",value:o.value,onInput:a},null,40,tD),nD],40,eD)]))}}),sD=at(rD,[["__file","/home/luuk/code/realtime-chat/src/components/chat/ChatInput.vue"]]),iD={class:"w-full bg-surface-200 flex items-center justify-between text-onDark"},oD=H("svg",{class:"w-8 h-8",fill:"currentColor",viewBox:"0 0 20 20",xmlns:"http://www.w3.org/2000/svg"},[H("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M10.7071 4.29289C11.0976 4.68342 11.0976 5.31658 10.7071 5.70711L6.41421 10L10.7071 14.2929C11.0976 14.6834 11.0976 15.3166 10.7071 15.7071C10.3166 16.0976 9.68342 16.0976 9.29289 15.7071L4.29289 10.7071C3.90237 10.3166 3.90237 9.68342 4.29289 9.29289L9.29289 4.29289C9.68342 3.90237 10.3166 3.90237 10.7071 4.29289Z"})],-1),aD=[oD],cD={class:"flex gap-2 items-center"},lD=["src"],uD={class:"text-2xl"},hD=H("div",null,null,-1),dD=Je({__name:"ChatToolbar",props:{chatId:{type:null,required:!0}},setup(t){const e=t,n=ko(),{chats:r}=Oa(n),s=Vd();Oa(s);const i=Ve(()=>r.value.find(l=>l.id===e.chatId)),o=Ve(()=>{var h;if(!i.value)return{displayName:"",photoURL:""};if(i.value.groupchat)return{displayName:i.value.groupchat.name,photoURL:i.value.groupchat.photoURL};const c=(h=je.currentUser)==null?void 0:h.uid,l=i.value.participants.find(d=>d!==c);return s.users.find(d=>d.id===l)??{displayName:"",photoURL:""}}),a=()=>{mr.push({path:"/"})};return(c,l)=>(ne(),_e("header",iD,[H("div",{class:"flex"},[H("button",{class:"p-2 rounded-full emphasis-high",onClick:a},aD)]),H("div",cD,[H("img",{src:o.value.photoURL?o.value.photoURL:Ne(Co),alt:"Profile",height:"32",width:"32",class:"w-8 h-8 aspect-square rounded-full object-cover",referrerpolicy:"no-referrer"},null,8,lD),H("h1",uD,On(o.value.displayName),1)]),hD]))}}),fD=at(dD,[["__file","/home/luuk/code/realtime-chat/src/components/chat/ChatToolbar.vue"]]),pD={class:"flex flex-col h-full flex-1"},gD={key:1,class:"flex-1 flex justify-center items-center"},mD=H("p",{class:"text-2xl text-onDark"},"Select a chat to start messaging",-1),_D=[mD],yD={key:2,class:"flex-1 overflow-y-auto flex flex-col p-1 gap-1"},vD={key:3,class:"flex-1 flex justify-center items-center"},wD=H("p",{class:"text-2xl text-onDark"},"No messages yet",-1),ED=[wD],ID=Je({__name:"ChatMain",props:{chatId:{type:null,required:!0}},setup(t){const e=t,n=ko(),{chats:r}=Oa(n),s=Ve(()=>r.value.find(o=>o.id===e.chatId));return(i,o)=>(ne(),_e("section",pD,[i.chatId?(ne(),Nt(fD,{key:0,"chat-id":i.chatId},null,8,["chat-id"])):zr("v-if",!0),s.value?s.value&&s.value.messages?(ne(),_e("div",yD,[(ne(!0),_e(st,null,Ra(s.value.messages,a=>(ne(),Nt(JN,{key:a.id,message:a},null,8,["message"]))),128))])):(ne(),_e("div",vD,ED)):(ne(),_e("div",gD,_D)),i.chatId?(ne(),Nt(sD,{key:4,"chat-id":i.chatId},null,8,["chat-id"])):zr("v-if",!0)]))}}),TD=at(ID,[["__file","/home/luuk/code/realtime-chat/src/components/chat/ChatMain.vue"]]),AD={class:"flex h-full"},bD=Je({__name:"ChatView",props:{chatId:{type:null,required:!0}},setup(t){const e=je.currentUser;return(n,r)=>(ne(),_e("main",AD,[H("section",{class:xs(["bg-surface-100 h-full",{"w-full md:w-80":!n.chatId,"hidden md:w-80 md:inline":n.chatId}])},[et(AN,{user:Ne(e)},null,8,["user"]),et(GN)],2),et(TD,{chatId:n.chatId,class:xs({"hidden md:flex":!n.chatId,"":n.chatId})},null,8,["chatId","class"])]))}}),RD=at(bD,[["__file","/home/luuk/code/realtime-chat/src/views/ChatView.vue"]]),PD={key:1},SD=Je({__name:"HomeView",props:{chatId:{type:String,required:!1}},setup(t){const e=xe(je.currentUser);return fN(n=>{e.value=n}),(n,r)=>e.value?(ne(),Nt(RD,{key:0,chatId:n.chatId},null,8,["chatId"])):(ne(),_e("p",PD,"Sign in to see your profile"))}}),Eg=at(SD,[["__file","/home/luuk/code/realtime-chat/src/views/HomeView.vue"]]),CD={class:"w-full h-full flex justify-center items-center"},kD=["onSubmit"],OD=H("h1",{class:"text-5xl font-bold text-center text-onDark"},"Sign In",-1),xD={class:"flex flex-col gap-4"},ND=H("b",null,"Register here",-1),DD=Je({__name:"LoginView",setup(t){const e=xe(""),n=xe(""),r=async()=>{await mN(e.value,n.value)&&mr.push({path:"/"})},s=async()=>{const i=await gN();i&&(await Fw(i.user.uid,i.user.displayName??"New user",i.user.photoURL),mr.push({path:"/"}))};return(i,o)=>(ne(),_e("main",CD,[H("form",{onSubmit:lh(r,["prevent"]),class:"flex flex-col bg-surface-100 p-8 rounded-lg gap-8"},[OD,H("div",xD,[Xn(H("input",{"onUpdate:modelValue":o[0]||(o[0]=a=>e.value=a),type:"email",placeholder:"Email",class:"p-2 rounded-xl text-onDark focus:outline-none text-lg bg-surface-200"},null,512),[[Zn,e.value]]),Xn(H("input",{"onUpdate:modelValue":o[1]||(o[1]=a=>n.value=a),type:"password",placeholder:"Password",class:"p-2 rounded-xl text-onDark focus:outline-none text-lg bg-surface-200"},null,512),[[Zn,n.value]]),H("button",{onClick:r,class:"bg-primary rounded-full p-2 text-onLight text-lg"}," Sign In "),et(Ne(mh),{to:"/register",class:"text-center text-base"},{default:uc(()=>[sh(" Don't have an account? "),ND]),_:1})]),H("button",{onClick:s,type:"button",class:"bg-[#3c82f7] px-1 py-2 rounded-md text-onLight text-lg"}," Sign In with Google ")],40,kD)]))}}),VD=at(DD,[["__file","/home/luuk/code/realtime-chat/src/views/LoginView.vue"]]),MD={class:"w-full h-full flex justify-center items-center"},LD={class:"flex flex-col bg-surface-100 p-8 rounded-lg gap-8"},UD=H("h1",{class:"text-5xl font-bold text-center text-onDark"},"Register",-1),FD=["onSubmit"],$D={class:"text-error text-center"},jD={class:"bg-primary rounded-full p-2 text-onLight text-lg"},BD={key:0},qD={key:1},HD=Je({__name:"RegisterView",setup(t){const e=xe(""),n=xe(""),r=xe(""),s=xe(""),i=xe(null),o=xe(""),a=xe(!1),c=u=>{const d=u.target.files[0];i.value=d},l=async()=>{if(a.value=!0,n.value!==r.value)return;const{user:u,error:h}=await _N(e.value,n.value,s.value,i.value);if(h){o.value=h.errorMessage,a.value=!1;return}mr.push({path:"/"})};return(u,h)=>(ne(),_e("main",MD,[H("div",LD,[UD,H("form",{class:"flex flex-col gap-4",onSubmit:lh(l,["prevent"])},[Xn(H("input",{"onUpdate:modelValue":h[0]||(h[0]=d=>e.value=d),type:"email",placeholder:"Email",class:"p-2 rounded-xl text-onDark focus:outline-none text-lg bg-surface-200"},null,512),[[Zn,e.value]]),Xn(H("input",{"onUpdate:modelValue":h[1]||(h[1]=d=>s.value=d),type:"text",placeholder:"Display Name",class:"p-2 rounded-xl text-onDark focus:outline-none text-lg bg-surface-200"},null,512),[[Zn,s.value]]),Xn(H("input",{"onUpdate:modelValue":h[2]||(h[2]=d=>n.value=d),type:"password",placeholder:"Password",class:"p-2 rounded-xl text-onDark focus:outline-none text-lg bg-surface-200"},null,512),[[Zn,n.value]]),Xn(H("input",{"onUpdate:modelValue":h[3]||(h[3]=d=>r.value=d),type:"password",placeholder:"Confirm Password",class:"p-2 rounded-xl text-onDark focus:outline-none text-lg bg-surface-200"},null,512),[[Zn,r.value]]),H("input",{onChange:c,type:"file",class:"p-2 rounded-xl text-onDark focus:outline-none text-lg bg-surface-200"},null,32),H("p",$D,On(o.value),1),H("button",jD,[a.value?(ne(),_e("p",BD,"Loading...")):(ne(),_e("p",qD,"Register"))])],40,FD)])]))}}),WD=at(HD,[["__file","/home/luuk/code/realtime-chat/src/views/RegisterView.vue"]]),KD={class:"flex h-full w-full justify-center items-center"},zD={class:"md:grid md:grid-cols-2 bg-surface-100 p-8 rounded-lg text-xl"},GD=H("div",{class:"flex md:hidden justify-center"},[H("h1",{class:"text-6xl text-onDark"},"Settings")],-1),QD={class:"border-transparent md:border-surface-400 border-r-2 p-8 flex flex-col items-start gap-4"},YD=["src"],JD=["disabled"],XD={key:0},ZD={key:1},eV=H("h1",{class:"text-6xl text-onDark hidden md:inline"},"Settings",-1),tV=Je({__name:"SettingsView",setup(t){const e=xe(je.currentUser);if(!e.value)throw new Error("User not logged in");const n=xe(e.value.displayName),r=xe(!1),s=async()=>{r.value=!0,e.value=je.currentUser,e.value&&(aN(e.value.uid,{displayName:n.value??e.value.displayName??"New user"}),await $_(e.value,{displayName:n.value}),r.value=!1)},i=async()=>{await yN(),mr.push({path:"/"})};return(o,a)=>{var c,l;return ne(),_e("main",KD,[H("div",zD,[GD,H("div",QD,[H("img",{src:(c=e.value)!=null&&c.photoURL?e.value.photoURL:Ne(Co),alt:"Profile",class:"w-32 aspect-square object-cover rounded-full",referrerpolicy:"no-referrer"},null,8,YD),Xn(H("input",{"onUpdate:modelValue":a[0]||(a[0]=u=>n.value=u),class:"bg-surface-200 text-onDark p-2 rounded-lg focus:outline-none focus:bg-surface-300",placeholder:"Display Name"},null,512),[[Zn,n.value]]),H("button",{class:"bg-primary text-onLight p-2 rounded-lg disabled:text-onDark transition-colors disabled:bg-surface-300 disabled:cursor-not-allowed",onClick:s,disabled:n.value===((l=e.value)==null?void 0:l.displayName)||!n.value},[r.value?(ne(),_e("span",XD,"Saving...")):(ne(),_e("span",ZD,"Save"))],8,JD)]),H("div",{class:"flex flex-col justify-evenly items-center gap-8"},[eV,H("button",{onClick:i,class:"bg-error text-onLight p-2 rounded-lg hover:emphasis-high"}," Logout ")])])])}}}),nV=at(tV,[["__file","/home/luuk/code/realtime-chat/src/views/SettingsView.vue"]]),mr=qb({history:HA("/"),routes:[{path:"/",name:"home",component:Eg},{path:"/login",name:"login",component:VD},{path:"/settings",name:"settings",component:nV},{path:"/register",name:"register",component:WD},{path:"/:chatId",name:"chat",props:!0,component:Eg}]});mr.beforeEach(async(t,e,n)=>{const s=!["/login","/register"].includes(t.path);await je.authStateReady();const i=je.currentUser;s?i?n():n("/login"):i?n("/"):n()});const Md=zT(FS);Md.use(TA());Md.use(mr);Md.mount("#app");
